...
<br />
<br />
<div class="container display-4 subTitleShadow">Inbox</div>
<br />
<br />
<br />
<br />
...
<div class="container">
    <table id="cases" class="table table-striped table-bordered table-hover table-dark" style="width:100%">
        ...
        $rslt = mysqli_query($cn , "select  id , name , email , subject, msg , created_at from inbox where archived = 0 ");
...
//          var_dump($row);
          ?>
            <tr>
                ...
                <td><a href="archive.php?postID=<?php echo $row[0]?>" class="fas fa-arrow-circle-down editIcon"> Archive</a></td>
...
<div class="container buttonsForAdmins  d-flex justify-content-end">
    <div class="btn-group">
        <button onclick="location.href='archived.php'" type="button" class="btn btn-dark">Archived</button>
